        ...
        <div class="conteiner1">
            <div class="image-container">
                <div class="small-image">
                    <img src="../fotos/zapatilla4/2.jpg" class="imagen-2">
                    <img src="../fotos/zapatilla4/3.jpg" class="imagen-2">
                    <img src="../fotos/zapatilla4/4.jpg" class="imagen-2">
                </div>
                <div class="big-imagen">
                    <img src="../fotos/zapatilla4/1.jpg" class="imagen-1">
                </div>
                <div class="content">
                    <h2>Air Jordan 1 Sail and Pale Vanilla</h2>
                    <br>
                    <p class="precio">189,99 €</p>
                    <br>
                    <p>Los neutros son la clave. Y más con una parte superior de piel flor en el bello color sail como telón de fondo. Si a eso le añadimos una mediasuela en blanco y unos cordones en pale vanilla, tenemos el equilibrio perfecto. El diseño se remata con un Swoosh de tela para dar un toque de textura exclusivo que destaca al máximo. Esta sólida base no puede ser más que el comienzo perfecto para tu look. ¿Con qué vas a combinarla?
                    </p>
                    <div class="talla">
                    <table>
                          <tbody>
                 ...
                 <div class="pago">
                    <button id="button2" class="boton-comprar" data-producto="4">Comprar 189,99 €</button>
                 </div>
                </div>
