        ...
        <div class="conteiner1">
            <div class="image-container">
                <div class="small-image">
                    <img src="../fotos/zapatilla10/2.jpg" class="imagen-2">
                    <img src="../fotos/zapatilla10/3.jpg" class="imagen-2">
                    <img src="../fotos/zapatilla10/4.jpg" class="imagen-2">
                </div>
                <div class="big-imagen">
                    <img src="../fotos/zapatilla10/1.jpg" class="imagen-1">
                </div>
                <div class="content">
                    <h2>Air Jordan 4 A Ma Maniére</h2>
                    <br>
                    <p class="precio">224,99 €</p>
                    <br>
                    <p>"Lo importante no son las zapatillas, sino hacia dónde vas". La franquicia Jordan ha vuelto a colaborar con la marca A Ma Maniére de James Whitner para ofrecerte unas AJ4 que derrochan moda y cultura urbana y que te acompañarán a lo más alto. La parte superior en violet ore con cordones a juego proporciona un estilo impecable y añade un toque elevado a tus looks. Además, los elegantes pines metálicos, los detalles de malla tonal y el interior acolchado aportan exclusividad en cada paso. No olvides echar un vistazo a la etiqueta de edición especial en la suela interior que refuerza el estilo urbano. En resumen: no busques más.
                    </p>
                    <div class="talla">
                    <table>
                          <tbody>
                 ...
                 <div class="pago">
                    <button id="button2" class="boton-comprar" data-producto="10">Comprar 224,99 €</button>
                 </div>
                </div>
