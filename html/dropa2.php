        ...
        <div class="padd">
            <div class="container1">
                <div class="image-container">
                    <div class="photo">
                        <img src="../fotos/ropa2/1.jpg" alt="Ropa 1">
                    </div>
                    <div class="photo">
                        <img src="../fotos/ropa2/2.jpg" alt="Ropa 2">
                    </div>
                    <div class="photo">
                        <img src="../fotos/ropa2/3.jpg" alt="Ropa 3">
                    </div>
                    <div class="photo">
                        <img src="../fotos/ropa2/4.jpg" alt="Ropa 4">
                    </div>
                </div>
                <div class="contenedor">
                    <div class="space1">
                        <p>Jordan x UNION x Bephies Beauty Supply</p>
                        <br>
                        <h2>Sudadera con capucha de tejido Fleece</h2>
                            <br>
                            <p class="precio">149,99 €</p>
                            <br>
                            <p>Disfruta de las noches frescas de verano con esta sudadera con capucha exclusiva. El parche cosido representa la colaboración, mientras que el efecto lavado por toda la prenda añade un estilo retro a tu look.
                            </p>
                            <div class="talla">
                            <table>
                                <tbody>
                        ...
                        <div class="pago">
                            <button id="button" class="boton-comprar" data-producto="14">Comprar 149,99 €</button>
                        </div>
                    </div>
                </div>
            </div>
