        ...
        <div class="padd">
            <div class="container1">
                <div class="image-container">
                    <div class="photo">
                        <img src="../fotos/ropa6/1.jpg" alt="Ropa 1">
                    </div>
                    <div class="photo">
                        <img src="../fotos/ropa6/2.jpg" alt="Ropa 2">
                    </div>
                    <div class="photo">
                        <img src="../fotos/ropa6/3.jpg" alt="Ropa 3">
                    </div>
                    <div class="photo">
                        <img src="../fotos/ropa6/4.jpg" alt="Ropa 4">
                    </div>
                </div>
                <div class="contenedor">
                    <div class="space1">
                        <p>Nike x Stüssy</p>
                        <br>
                        <h2>Chaqueta de lana a rayas</h2>
                            <br>
                            <p class="precio">174,99 €</p>
                            <br>
                            <p>Añade un toque diferente al look básico con detalles a rayas y un estampado Stüssy repetido. Además, la etiqueta personalizada y el Swoosh cosidos y el bordado "Stüssy" consiguen un toque rebelde.
                            </p>
                            <div class="talla">
                            <table>
                                <tbody>                               
                        ...
                        <div class="pago">
                            <button id="button" class="boton-comprar" data-producto="22">Comprar 174,99 €</button>
                        </div>
                    </div>
                </div>
            </div>
