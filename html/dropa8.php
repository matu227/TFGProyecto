			...
			<div class="container2">
                ...
                <div class="content">
                    <div class="space">
                        ...
                        <div class="pago">
                            <button id="button" class="boton-comprar" data-producto="24">Comprar 64,99 €</button>
                        </div>
                    </div>
                </div>
                <div class="image-container">
                ...
                <div class="content">
                    <div class="space1">
                        ...
                        <div class="pago">
                            <button id="button" class="boton-comprar" data-producto="25">Comprar 129,99 €</button>
                        </div>
                    </div>
                </div>
                <div class="image-container">
                ...
                <div class="content">
                    <div class="space2">
                        ...
                        <div class="pago">
                            <button id="button" class="boton-comprar" data-producto="26">Comprar 349,99 €</button>
                        </div>
                    </div>
                </div>
                <div class="image-container">
                ...
                <div class="content">
                    <div class="space3">
                        ...
                        <div class="pago">
                            <button id="button" class="boton-comprar" data-producto="27">Comprar 499,99 €</button>
                        </div>
                    </div>
                </div>
                <div class="image-container">
                ...
                <div class="content">
                    <div class="space4">
                        ...
                        <div class="pago">
                            <button id="button" class="boton-comprar" data-producto="28">Comprar 49,99 €</button>
                        </div>
                    </div>
                </div>
            </div>
