            ...
            <div class="container2">
                ...
                <div class="content">
                    <div class="space">
                        ...
                        <div class="pago">
                            <button id="button" class="boton-comprar" data-producto="16">Comprar 599,99 €</button>
                        </div>
                    </div>
                </div>
                <div class="image-container">
                ...
                <div class="content">
                    <div class="space2">
                        ...
                        <div class="pago">
                            <button id="button" class="boton-comprar"  data-producto="17">Comprar 399,99 €</button>
                        </div>
                    </div>
                </div>
                <div class="image-container">
                ...
                <div class="content">
                    <div class="space3">
                        ...
                        <div class="pago">
                            <button id="button" class="boton-comprar" data-producto="18">Comprar 399,99 €</button>
                        </div>
                    </div>
                </div>
                <div class="image-container">
                ...
                <div class="content">
                    <div class="space4">
                        ...
                        <div class="pago">
                            <button id="button" class="boton-comprar" data-producto="19">Comprar 399,99 €</button>
                        </div>
                    </div>
                </div>
                <div class="image-container">
                ...
                <div class="content">
                    <div class="space5">
                        ...
                        <div class="pago">
                            <button id="button" class="boton-comprar" data-producto="20">Comprar 79,99 €</button>
                        </div>
                    </div>
                </div>
            </div>
