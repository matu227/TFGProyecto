    ...
    <header>
        <nav>
            ...
            <ul class="menu">
                ...
                <li class="back"><a class="active" href="../contacto.html">Login</a></li>\
                <?php 
        ...
        <div class="conteiner1">
            <div class="image-container">
                <div class="small-image">
                    <img src="../fotos/zapatilla2/zpa14.jpg" class="imagen-2">
                    <img src="../fotos/zapatilla2/zpa13.jpg" class="imagen-2">
                    <img src="../fotos/zapatilla2/zpa15.jpg" class="imagen-2">
                </div>
                <div class="big-imagen">
                    <img src="../fotos/zapatilla2/zpa12.jpg" class="imagen-1">
                </div>
                <div class="content">
                    <h2>Air Jordan 1 Zoom CMFT 2 x Teyana Taylor Gym Red</h2>
                    <br>
                    <p class="precio">169,99 €</p>
                    <br>
                    <p>Inspirada en la creatividad sin límites de Teyana Taylor y el exclusivo ADN del diseño Jordan, esta colaboración rinde homenaje a todo el mundo que supera sus luchas. Igual que los rosales pueden crecer en lugares inhóspitos, no hay situación que pueda detenerte o en la que no puedas florecer. Por eso, Teyana toma las AJ1 y las embellece con detalles atrevidos: uno de los Swoosh tiene unas espinas bordadas, mientras que el otro se hunde en la mediasuela. Además, los dos ojales superiores revelan un mensaje especial al desatar los cordones. Todos estos elementos brillan con fuerza al combinarlos para crear unas zapatillas llamativas y preciosas.
                    </p>
                        <div class="talla">
                            <table>
                                <tbody>
                    ...
                    <div class="pago">
                        <button id="button2" class="boton-comprar" data-producto="2">Comprar 169,00 €</button>
                    </div>
                </div>
            </div>
        </div>
