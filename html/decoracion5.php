        ...
        <div class="conteiner1">
            <div class="image-container">
                <div class="small-image">
                    <img src="../fotos/zapatilla5/2.jpg" class="imagen-2">
                    <img src="../fotos/zapatilla5/3.jpg" class="imagen-2">
                    <img src="../fotos/zapatilla5/4.jpg" class="imagen-2">
                </div>
                <div class="big-imagen">
                    <img src="../fotos/zapatilla5/1.jpg" class="imagen-1">
                </div>
                <div class="content">
                    <h2>Air Jordan 6 Toro Bravo</h2>
                    <br>
                    <p class="precio">209,99 €</p>
                    <br>
                    <p>Para muchos Nike Members, estas zapatillas son un lanzamiento muy esperado. Las AJ6 "Toro Bravo" recuperan el aclamado look del Raging Bull pack de 2009 con un diseño ganador. Estas AJ6, que están inspiradas en los coches deportivos alemanes de MJ, cuentan con un diseño adornado que engalana el ante texturizado y el acabado varisty red de toda la superficie. Y es que a veces vale la pena esperar por algo tan especial.
                    </p>
                    <div class="talla">
                    <table>
                          <tbody>
                 ...
                 <div class="pago">
                    <button id="button2" class="boton-comprar" data-producto="5">Comprar 209,99 €</button>
                 </div>
                </div>
