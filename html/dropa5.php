        ...
        <div class="padd">
            <div class="container1">
                <div class="image-container">
                    <div class="photo">
                        <img src="../fotos/ropa5/1.jpg" alt="Ropa 1">
                    </div>
                    <div class="photo">
                        <img src="../fotos/ropa5/2.jpg" alt="Ropa 2">
                    </div>
                    <div class="photo">
                        <img src="../fotos/ropa5/3.jpg" alt="Ropa 3">
                    </div>
                    <div class="photo">
                        <img src="../fotos/ropa5/4.jpg" alt="Ropa 4">
                    </div>
                </div>
                <div class="contenedor">
                    <div class="space1">
                        <p>Nike SB x Concepts</p>
                        <br>
                        <h2>Sudadera con capucha de tejido Fleece</h2>
                            <br>
                            <p class="precio">79,99 €</p>
                            <br>
                            <p>Las rosas son rojas, las langostas naranjas y esta sudadera con capucha de suave Fleece representa las zapatillas Concepts más increíbles hasta la fecha. Los estampados de delante y de detrás hacen un guiño a las Nike SB x Concepts Dunk "Orange Lobster" y, con un diseño ultracómodo y espacioso, se va a convertir en tu favorita.
                            </p>
                            <div class="talla">
                            <table>
                                <tbody>
                        ...
                        <div class="pago">
                            <button id="button" class="boton-comprar" data-producto="21">Comprar 79,99 €</button>
                        </div>
                    </div>
                </div>
            </div>
