    ...
    <header>
        <nav>
            ...
            <ul class="menu">
                ...
                ?>
                <li class="submenu">
                <a href="carrito.php"><img class="img-cesta" src="../sfotos/cesta.png"></a>
                    <div id="cesta">
        ...
        <div class="conteiner1">
            <div class="image-container">
                <div class="small-image">
                    <img src="../fotos/zapatilla6/2.jpg" class="imagen-2">
                    <img src="../fotos/zapatilla6/3.jpg" class="imagen-2">
                    <img src="../fotos/zapatilla6/4.jpg" class="imagen-2">
                </div>
                <div class="big-imagen">
                    <img src="../fotos/zapatilla6/1.jpg" class="imagen-1">
                </div>
                <div class="content">
                    <h2>Air Jordan 5 Craft</h2>
                    <br>
                    <p class="precio">219,99 €</p>
                    <br>
                    <p>Esta versión artesanal de las AJ5 te ofrece el máximo estilo con una combinación premium de ante y lona en un look actualizado del inconfundible diseño de 1990. Los colores etéreos inspirados en el desierto añaden una estética viajera y funcional con muchos tonos en safety orange que suben la temperatura. Además, las zapatillas llevan toques translúcidos, detalles de salpicaduras de pintura y una suela exterior azul translúcida para que llevarte donde quieras. Este diseño derrocha estilo en cada pisada.
                    </p>
                    <div class="talla">
                    <table>
                          <tbody>
                 ...
                 <div class="pago">
                    <button id="button2" class="boton-comprar" data-producto="6">Comprar 219,99 €</button>
                 </div>
                </div>
