        ...
        <div class="conteiner1">
            <div class="image-container">
                <div class="small-image">
                    <img src="../fotos/zapatilla7/2.jpg" class="imagen-2">
                    <img src="../fotos/zapatilla7/3.jpg" class="imagen-2">
                    <img src="../fotos/zapatilla7/4.jpg" class="imagen-2">
                </div>
                <div class="big-imagen">
                    <img src="../fotos/zapatilla7/1.jpg" class="imagen-1">
                </div>
                <div class="content">
                    <h2>Air Jordan 1 High Multicolor</h2>
                    <br>
                    <p class="precio">189,99 €</p>
                    <br>
                    <p>Llama la atención de día y de noche con las Air Jordan 1. El tejido vaquero premium de la parte superior está teñido con un degradado de más claro a más oscuro y cambia del tono del amanecer hasta el del crepúsculo de forma impecable. Además, el diseño asimétrico te permite crear una atmósfera con tu estilo. Para completar el diseño, la amortiguación Nike Air en la planta del pie te ofrece comodidad vayas donde vayas. El límite es el cielo gracias a este diseño.
                    </p>
                    <div class="talla">
                    <table>
                          <tbody>
                 ...
                 <div class="pago">
                    <button id="button2" class="boton-comprar" data-producto="7">Comprar 189,99 €</button>
                 </div>
                </div>
