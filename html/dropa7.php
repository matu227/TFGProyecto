        ...
        <div class="padd">
            <div class="container1">
                <div class="image-container">
                    <div class="photo">
                        <img src="../fotos/ropa7/1.jpg" alt="Ropa 1">
                    </div>
                    <div class="photo">
                        <img src="../fotos/ropa7/2.jpg" alt="Ropa 2">
                    </div>
                    <div class="photo">
                        <img src="../fotos/ropa7/3.jpg" alt="Ropa 3">
                    </div>
                    <div class="photo">
                        <img src="../fotos/ropa7/4.jpg" alt="Ropa 4">
                    </div>
                </div>
                <div class="contenedor">
                    <div class="space1">
                        ...
                        <div class="pago">
                            <button id="button" class="boton-comprar" data-producto="23">Comprar 174,99 €</button>
                        </div>
                    </div>
                </div>
            </div>
