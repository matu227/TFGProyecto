           ...
           <div class="principal">
			...
			<div class="container2">
				<div class="image-container">
					<div class="photo">
						<img src="../fotos/ropa10/1.jpg" alt="Ropa 1">
					</div>
					<div class="photo">
						<img src="../fotos/ropa10/2.jpg" alt="Ropa 1">
					</div>
				</div>
				<div class="content">
                    <div class="space"> 
						...
						<h2>Sudadera con capucha</h2>
						 ...
						 <div class="pago">
						 	<button id="button" class="boton-comprar" data-producto="34">Comprar 149,99 €</button>
						 </div>
                    </div>
                </div>
				<div class="image-container">
					<div class="photo">
						<img src="../fotos/ropa10/3.jpg" alt="Ropa 2">
					</div>
					<div class="photo">
						<img src="../fotos/ropa10/4.jpg" alt="Ropa 3">
					</div>
				</div>
				<div class="content">
					<div class="space1">
						...
						<h2>Sudadera</h2>
						 ...
						 <div class="pago">
						 	<button id="button" class="boton-comprar" data-producto="35">Comprar 119,99 €</button>
						 </div>
					</div>
                </div>
				<div class="image-container">
					<div class="photo">
						<img src="../fotos/ropa10/5.jpg" alt="Ropa 4">
					</div>
					<div class="photo">
						<img src="../fotos/ropa10/6.jpg" alt="Ropa 4">
					</div>
				</div>
				<div class="content">
					<div class="space2">
						...
						<h2>Camiseta</h2>
						 ...
						 <div class="pago">
						 	<button id="button" class="boton-comprar" data-producto="36">Comprar 49,99 €</button>
						 </div>
					</div>
                </div>
				<div class="image-container">
					<div class="photo">
						<img src="../fotos/ropa10/7.jpg" alt="Ropa 4">           
					</div>
					 <div class="photo">
						<img src="../fotos/ropa10/8.jpg" alt="Ropa 4">
					</div>
				</div>
				<div class="content">
					<div class="space3">
						...
						<h2>Pantalón de tejido Fleece</h2>
						 ...
						 <div class="pago">
						 	<button id="button" class="boton-comprar" data-producto="37">Comprar 119,99 €</button>
						 </div>
					</div>
                </div>
				<div class="image-container">
					 <div class="photo">
						<img src="../fotos/ropa10/9.jpg" alt="Ropa 4">
					</div>
					 <div class="photo">
						<img src="../fotos/ropa10/10.jpg" alt="Ropa 4">
					</div>
				</div>
				<div class="content">
					<div class="space4">
						...
						<h2>Pantalón corto</h2>
						 ...
						 <div class="pago">
						 	<button id="button" class="boton-comprar" data-producto="38">Comprar 99,99 €</button>
						 </div>
					</div>
                </div>
			</div>
