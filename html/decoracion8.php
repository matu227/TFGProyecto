        ...
        <div class="conteiner1">
            <div class="image-container">
                <div class="small-image">
                    <img src="../fotos/zapatilla8/2.jpg" class="imagen-2">
                    <img src="../fotos/zapatilla8/3.jpg" class="imagen-2">
                    <img src="../fotos/zapatilla8/4.jpg" class="imagen-2">
                </div>
                <div class="big-imagen">
                    <img src="../fotos/zapatilla8/1.jpg" class="imagen-1">
                </div>
                <div class="content">
                    <h2>Air Jordan 1 Heritage</h2>
                    <br>
                    <p class="precio">169,99 €</p>
                    <br>
                    <p>La franquicia Jordan lleva muy adentro estos colores. El university red, el negro y el blanco son una seña de identidad instantánea del Jumpman, pero nunca antes se han combinado así. Con una mediasuela blanca, una base de piel blanca y una piel abatanada en negro y university red, este modelo original se enriquece con el auténtico legado de la franquicia Jordan. Diseñadas para un modelo tan atemporal como las Air Jordan, esta sencilla gama de colores clásicos destaca al máximo.
                    </p>
                    <div class="talla">
                    <table>
                          <tbody>
                 ...
                 <div class="pago">
                    <button id="button2" class="boton-comprar" data-producto="8">Comprar 169,99 €</button>
                 </div>
                </div>
