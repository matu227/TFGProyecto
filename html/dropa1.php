        ...
        <div class="padd">
            <div class="container1">
                    <div class="image-container">
                        <div class="photo">
                            <img src="../fotos/ropa1/1.jpg" alt="Ropa 1">
                        </div>
                        <div class="photo">
                            <img src="../fotos/ropa1/2.jpg" alt="Ropa 2">
                        </div>
                        <div class="photo">
                            <img src="../fotos/ropa1/3.jpg" alt="Ropa 3">
                        </div>
                        <div class="photo">
                            <img src="../fotos/ropa1/4.jpg" alt="Ropa 4">
                        </div>
                    </div>
                <div class="contenedor">
                    <div class="space1">
                        ...
                        <h2>Pantalón</h2>
                            ...
                            <br>
                            <p>Hemos usado un material duradero, que originalmente se creó para el pantalón Ishod SB, en zonas estratégicas de mayor desgaste. Así podemos ofrecer protección en todas tus aventuras. Los paneles por zonas y los bolsillos ergonómicos te ofrecen libertad de movimiento, mientras que el cinturón regulable te permite personalizar el ajuste sobre la marcha.
                            </p>
                            <div class="talla">
                            <table>
                                <tbody>
                        ...
                        <div class="pago">
                        <button id="button" class="boton-comprar" data-producto="13">Comprar 199,99 €</button>
                        </div>
                    </div>
                </div>
            </div>
