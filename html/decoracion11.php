        ...
        <div class="conteiner1">
            <div class="image-container">
                <div class="small-image">
                    <img src="../fotos/zapatilla11/2.jpg" class="imagen-2">
                    <img src="../fotos/zapatilla11/3.jpg" class="imagen-2">
                    <img src="../fotos/zapatilla11/4.jpg" class="imagen-2">
                </div>
                <div class="big-imagen">
                    <img src="../fotos/zapatilla11/1.jpg" class="imagen-1">
                </div>
                <div class="content">
                    <h2>Air Jordan 1 Starfish</h2>
                    <br>
                    <p class="precio">179,99 €</p>
                    <br>
                    <p>Esfuérzate al máximo en el juego y consigue la victoria. Estas zapatillas, que combinan el diseño italiano y el estilo innegable de MJ, están inspiradas en la equipación que llevó MJ en una gira de exhibición por Italia en el 85 y en su asombroso mate que rompió la canasta. La piel en relieve y la piel sintética semimate y superexclusiva tienen un aire sofisticado, mientras que las costuras gruesas potencian la energía fuera de la cancha. Además, la zona del tobillo con forro de tejido Fleece suave te ofrece un estilo de primera categoría.
                    </p>
                    <div class="talla">
                    <table>
                          <tbody>
                 ...
                 <div class="pago">
                    <button id="button2" class="boton-comprar" data-producto="11">Comprar 179,99 €</button>
                 </div>
                </div>
